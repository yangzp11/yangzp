package com.yzp.mybatis.generator;
...
public class CodeGenUtil {
    ...
    public static void main(String[] args) {
        ...
        boolean b = codeGenUtil.generateByTables(dataSourceConfig, "com.yzp.mybatis", "YangZhiPeng",
                "yangzp", "order", "order_clothes", "order_clothes_rewash", "order_clothes_operate");
    ...
    private static DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://127.0.0.1:3306/yzp?characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
    ...
    private String getJavaOutputDir(String projectName) {
        ...
        int index = path.lastIndexOf(projectName);
